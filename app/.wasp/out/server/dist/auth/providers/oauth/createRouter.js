...
export function createRouter(provider, initData) {
    ...
    router.get('/callback', passport.authenticate(passportStrategyName, {
        session: false,
        failureRedirect: waspServerConfig.frontendUrl + authConfig.failureRedirectPath
    }), handleRejection(async function (req, res) {
        var _a;
        const providerProfile = (_a = req === null || req === void 0 ? void 0 : req.wasp) === null || _a === void 0 ? void 0 : _a.providerProfile;
        if (!providerProfile) {
...
async function findOrCreateUserByExternalAuthAssociation(provider, providerId, getUserFields) {
    ...
    const userAndExternalAuthAssociation = Object.assign(Object.assign({}, userFields), { 
        // TODO: Decouple social from usernameAndPassword auth.
        password: uuidv4(), externalAuthAssociations: {
